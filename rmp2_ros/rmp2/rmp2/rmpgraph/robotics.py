    ...
    def get_control_points(self, link_positions, arm_collision_controllers):
        ...
        for controller in arm_collision_controllers:
            ...
            for k in range(interpolation_points):
                ...
                point = alpha * link_positions[end2][:,:3] + (1 - alpha) * link_positions[end1][:,:3]
                control_points.append(point)
        control_points = tf.reshape(control_points, (1,-1))
        return control_points
    
    # def update_arm_collision_controllers(self,coll_pts):
    #     for idx,controller in enumerate(self.arm_collision_controllers):
    #         controller['interpolation_pts'] = coll_pts[idx]
    ...
    def forward_mapping(self, q, **features):
        ...
        for i, key in enumerate(self.keys):
            ...
            # collision avoidance
                ...
                pts = self.get_control_points(link_positions, self.arm_collision_controllers)
                x.append(pts)
